...
export const listUserChatRooms = /* GraphQL */ `
    query ListUserChatRooms($filter: ModelUserChatRoomFilterInput, $limit: Int, $nextToken: String) {
...
export const syncUserChatRooms = /* GraphQL */ `
    query SyncUserChatRooms(
        ...
        syncUserChatRooms(filter: $filter, limit: $limit, nextToken: $nextToken, lastSync: $lastSync) {
            items {
                id
                chatRoomId
                userId
