...
export const createUserChatRoom = /* GraphQL */ `
    mutation CreateUserChatRoom($input: CreateUserChatRoomInput!, $condition: ModelUserChatRoomConditionInput) {
...
export const updateUserChatRoom = /* GraphQL */ `
    mutation UpdateUserChatRoom($input: UpdateUserChatRoomInput!, $condition: ModelUserChatRoomConditionInput) {
...
export const deleteUserChatRoom = /* GraphQL */ `
    mutation DeleteUserChatRoom($input: DeleteUserChatRoomInput!, $condition: ModelUserChatRoomConditionInput) {
